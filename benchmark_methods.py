...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["solver"],
        help="Method names to benchmark; use 'all' to include solver and every strategy",
    )
    parser.add_argument(
        "--scenario-set",
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="Restart count for the solver method",
    )
    parser.add_argument(
        "--time-budget",
        type=int,
        default=5000,
        help="Per-scenario time budget in ms for the solver method",
    )
    parser.add_argument(
